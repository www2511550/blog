<?php
function zbpNana_tt_touxiang_generate_first_letter_uri($name){
	global $zbp;
$name2=zbpNana_tt_touxiang_Getzimu($name);//新加
...
$name=$name2;
			...
			if (extension_loaded('mbstring')){ // check if mbstring is loaded to allow multibyte string operations
				...
				$file_name_mb=zbpNana_tt_touxiang_Getzimu($file_name_mb);//新加
...
function zbpNana_tt_touxiang_Getzimu($str) 
{ 
